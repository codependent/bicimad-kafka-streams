...
class JsonPojoSerializerTest {
    ...
    fun serialize() {
        ...
        assertEquals("""{"id":1,"latitude":"40.416896","longitude":"-3.7024255","name":"Puerta del Sol A","light":1,"number":"1a","address":"Puerta del Sol nº 1","activate":1,"no_available":0,"total_bases":24,"dock_bikes":16,"free_bases":5,"reservations_count":1}""", String(stationBA))
    }
}
